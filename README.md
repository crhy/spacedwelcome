...
![Spaced Linux Welcome 0.1.8 showing post-install apps from Flathub and Spaced GitHub](screenshots/welcome-0.1.8.png)
...
The package artifact is exactly `dist/spaced-welcome_0.1.8_all.deb`.
